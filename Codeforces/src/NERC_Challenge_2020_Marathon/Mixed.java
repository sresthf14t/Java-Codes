...
public class Mixed {
    ...
    public static void main(String args[]) throws IOException {
        ...
        sc1=new int[sc.length];
        sr1=new int[sr.length];
        vc1=new int[vc.length];
        vr1=new int[vr.length];
        curr1=new int[curr.length];
        move1=new int[move.length];
        copy(sc,sc1);
        copy(sr,sr1);
        copy(vc,vc1);
        copy(vr,vr1);
        copy(curr,curr1);
        copy(move,move1);
        solve_min_RAM_priority(startTime,n,m,sc1,sr1,vc1,vr1,curr1,move1,false);
        ...
        copy(curr,curr1);
        copy(move,move1);
        solve_min_cpu_RAM_priority(startTime,n,m,sc1,sr1,vc1,vr1,curr1,move1,false);
        ...
        copy(curr,curr1);
        copy(move,move1);
        solve_max_cpu_priority(startTime,n,m,sc1,sr1,vc1,vr1,curr1,move1,false);
        ...
        copy(curr,curr1);
        copy(move,move1);
        solve_max_RAM_priority(startTime,n,m,sc1,sr1,vc1,vr1,curr1,move1,false);
        ...
        copy(curr,curr1);
        copy(move,move1);
        solve_max_CPU_RAM_priority(startTime,n,m,sc1,sr1,vc1,vr1,curr1,move1,false);
...
//        System.out.println(total+"\n"+ans);
    ...
    public static void solve_min_RAM_priority(long startTime,int n,int m,int sc[],int sr[],int vc[],int vr[],int curr[],int move[],boolean rand) {
        long steps=0,mem=0;
        StringBuilder ans=new StringBuilder("");
        TreeMap<Integer,TreeSet<Integer>> tm=new TreeMap<>();
        for(int i=0;i<m;i++) {
            ...
            if(!tm.containsKey(vr[i])) {
                TreeSet<Integer> ts=new TreeSet<>();
                tm.put(vr[i], ts);
            }
            TreeSet<Integer> ts=tm.get(vr[i]);
            ts.add(i);
        }
        int total=0;
        Stack<Integer> stck_tm=new Stack<>();
...
//        System.out.println(total+"\n"+ans);
    ...
    public static void solve_min_cpu_RAM_priority(long startTime,int n,int m,int sc[],int sr[],int vc[],int vr[],int curr[],int move[],boolean rand) {
        long steps=0,mem=0;
        StringBuilder ans=new StringBuilder("");
        TreeMap<Integer,TreeSet<Integer>> tm=new TreeMap<>();
        for(int i=0;i<m;i++) {
            ...
            if(!tm.containsKey(vc[i]+vr[i])) {
                TreeSet<Integer> ts=new TreeSet<>();
                tm.put(vc[i]+vr[i], ts);
            }
            TreeSet<Integer> ts=tm.get(vc[i]+vr[i]);
            ts.add(i);
        }
        int total=0;
        Stack<Integer> stck_tm=new Stack<>();
...
//        System.out.println(total+"\n"+ans);
    ...
    public static void solve_max_cpu_priority(long startTime,int n,int m,int sc[],int sr[],int vc[],int vr[],int curr[],int move[],boolean rand) {
        long steps=0,mem=0;
        StringBuilder ans=new StringBuilder("");
        TreeMap<Integer,TreeSet<Integer>> tm=new TreeMap<>();
        for(int i=0;i<m;i++) {
...
//        System.out.println(total+"\n"+ans);
    ...
    public static void solve_max_RAM_priority(long startTime,int n,int m,int sc[],int sr[],int vc[],int vr[],int curr[],int move[],boolean rand) {
        int rem=m;
        long steps=0,mem=0;
        StringBuilder ans=new StringBuilder("");
        TreeMap<Integer,TreeSet<Integer>> tm=new TreeMap<>();
...
//        System.out.println(total+"\n"+ans);
    ...
    public static void solve_max_CPU_RAM_priority(long startTime,int n,int m,int sc[],int sr[],int vc[],int vr[],int curr[],int move[],boolean rand) {
        int rem=m;
        long steps=0,mem=0;
        StringBuilder ans=new StringBuilder("");
        TreeMap<Integer,TreeSet<Integer>> tm=new TreeMap<>();
