...
//        }
        ...
        try {
        outputstream=new PrintWriter(new FileOutputStream("f_libraries_of_the_world.txt",false));
        }
        ...
        while(Days>0 && count_lib>0) {
            ...
            int best_lib=find_best_Lib(Lib,Days,b_score , no_of_days_sign, no_of_books_to_scan, books_in_lib,no_of_books_in_lib,no_of_days_sign_to_take);
...
//               System.out.println(books);
    ...
    public static int find_best_Lib(int Lib,int Days, int[] b_score ,int[] no_of_days_sign, int[] no_of_books_to_scan, ArrayList<Integer>[] books_in_lib,int[] no_of_books_in_lib,int no_of_days_sign_to_take) {
