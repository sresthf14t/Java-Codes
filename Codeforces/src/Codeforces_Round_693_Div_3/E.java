...
public class E {
    ...
    public static void main(String args[]) throws IOException {
        ...
        for(int tt=1;tt<=test;tt++) {
            ...
            seg_tree st=new seg_tree(n,brr);
            ...
            for(int i=0;i<n;i++) {
                ...
                int idx=jlt(arr,arr[i]);
                int min[]=st.min(0, 0, n-1, 0, idx);

                if(min[1]<brr[i]) {
                    fin[indx[i]]=indx[min[0]]+1;
                    continue;
                }

                st.update(0, 0, n-1, i, Integer.MAX_VALUE);
                idx=jlt(arr,brr[i]);
                min=st.min(0, 0, n-1, 0, idx);

                if(min[1]<arr[i]) {
                    fin[indx[i]]=indx[min[0]]+1;
                }

                st.update(0, 0, n-1, i, brr[i]);
    ...
    public static int jlt(int[] arr, int target)  
    {  
