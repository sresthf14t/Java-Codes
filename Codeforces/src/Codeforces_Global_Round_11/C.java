...
//        System.out.println(1);
        ...
        int max=-1;
        for(int i=1;i<n;i++) {
            for(int j=i-1;j>=Math.max(0,i-1001);j--) {
                if(pos(i,j) && dp[j]!=-1) {
...
//            System.out.print(dp[i]+" ");
    ...
    public static boolean pos(int indx1,int indx2) {
        int d=Math.abs(x[indx1]-x[indx2])+Math.abs(y[indx1]-y[indx2]);
        int t=Math.abs(time[indx1]-time[indx2]);
        if(d<=t) {
            return true;
        }
        return false;
