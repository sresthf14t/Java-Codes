...
//        }
    ...
    public static boolean check(int arr[],int l,int r) {
        ...
        for(int i=0;i<=max_indx_pointer;i++) {
            ...
            //Left
            if(l>=max_strt_indx[i] && l<max_end_indx[i]) {
                left_bool=true;
            }
            else if(l<max_end_indx[i]){
            ...
            //Right
            if(r<=max_end_indx[i] && r>max_strt_indx[i]) {
                right_bool=true;
            }
            else if(r>max_strt_indx[i]){
        ...
        for(int i=0;i<=min_indx_pointer;i++) {
            ...
            //Left
            if(l>=min_strt_indx[i] && l<min_end_indx[i]) {
                left_bool=true;
            }
            else if(l<min_end_indx[i]){
            ...
            //Right
            if(r<=min_end_indx[i] && r>min_strt_indx[i]) {
                right_bool=true;
            }
            else if(r>min_strt_indx[i]){
