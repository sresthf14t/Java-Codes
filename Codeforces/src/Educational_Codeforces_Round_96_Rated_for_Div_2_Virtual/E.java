...
//        String str=generate(n);
        ...
        long ans=0;
        for(int i=0;i<n;i++) {
            char chr=str.charAt(n-i-1);
//            print(chr-'a');
            int indx=arr[chr-'a'][strt[chr-'a']];
//            System.out.println(i+" "+indx+" "+st.get(0, 0, n-1, arr[chr-'a'][strt[chr-'a']])+" "+str.charAt(n-i-1));
            ans+=indx+st.get(0, 0, n-1, arr[chr-'a'][strt[chr-'a']])-i;
            strt[chr-'a']++;
            st.update(0, 0, n-1, 0, indx-1, 1);
        }
    ...
    public static String generate(int n) {
        ...
        for(int i=0;i<n;i++) {
            char chr=(char)('a'+(int)(Math.random()*25));
            str.append(chr);
        }
        return ""+str;
    }
