...
//        Scanner input=new Scanner(new File("C:\\Users\\SRESTH\\Desktop\\HashCode\\HashCode 2022\\input_data\\e_exceptional_skills.in.txt"));
        ...
        int n_days_schedule=1000;  // no of days the office will run
        ...
        for(int i=0;i<n_days_schedule;i++) {
            ...
            int index_of_pending_project = index_of_pending_project(project_done, start_index_to_search_for_project);
...
//                if(skills_level[index_of_contributors.get(j)].get(skills_name[index_of_contributors.get(j)].indexOf(skills_name_required_for_project[index_of_pending_project])) == skills_level_required_for_project[index_of_pending_project].get(j)) {
//                    
//                    skills_level[index_of_contributors.get(j)].set(skills_name[index_of_contributors.get(j)].indexOf(skills_name_required_for_project[index_of_pending_project]), skills_level_required_for_project[index_of_pending_project].get(j) + 1);
//                    
//                }
            }
...
//        outputstream=new PrintWriter(new FileOutputStream("C:\\Users\\SRESTH\\Desktop\\HashCode\\HashCode 2022\\Output\\e_exceptional_skills.in.txt",false));
    ...
    public static int index_of_pending_project(boolean project_done[], int start_index) {
