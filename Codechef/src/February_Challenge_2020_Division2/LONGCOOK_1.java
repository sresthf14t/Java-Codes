...
public class LONGCOOK_1 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        for(int t=0;t<test;t++) {
            ...
            StringBuilder str=new StringBuilder("");
            //System.out.println("strt="+strt+" "+str.charAt(strt));
            int count=0;
            for(int i=strt;y1<=y2 && i<400;i++) {
                if(str.charAt(i)=='5') {
                    count++;
                }
                else if(str.charAt(i)=='6' && !is_leap(y1)) {
                    count++;
                }
                y1++;
            }
    ...
    public static int count1(int strt, int y1, int y2) {;
        StringBuilder str=new StringBuilder("");
        //System.out.println("strt="+strt+" "+str.charAt(strt));
        int count=0;
        for(int i=strt;y1<=y2;i=(i+1)%400) {
            if(str.charAt(i)=='5') {
                count++;
            }
            else if(str.charAt(i)=='6' && !is_leap(y1)) {
