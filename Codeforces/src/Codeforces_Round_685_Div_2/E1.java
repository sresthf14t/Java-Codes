...
public class E1 {
    ...
    public static void main(String args[]) throws IOException {
        ...
        System.out.flush();
        int a12=input.scanInt();
        System.out.println("XOR 1 2");
        System.out.flush();
        int x12=input.scanInt();
        int sum12=x12+2*a12;
        ...
        System.out.flush();
        int a23=input.scanInt();
        System.out.println("XOR 2 3");
        System.out.flush();
        int x23=input.scanInt();
        int sum23=x23+2*a23;
...
//        System.out.println(sum12+" "+sum23+" "+sum13);
        
        for(int i=3;i<n;i++) {
            System.out.println("XOR "+(i+1)+" "+1);
            System.out.flush();
