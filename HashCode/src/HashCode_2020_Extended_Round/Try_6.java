...
//        System.exit(0);
        ...
        int Lib_not_to_take_arr[]={31,201,204,209,210,219,247,261,312,319,369,422,457,515,563,595,618,622,694,719,774,828,901,902};
        ...
        try {
        outputstream=new PrintWriter(new FileOutputStream("f_libraries_of_the_world.txt",true));
        }
...
//               System.out.println(books);
    ...
    public static int find_best_Lib(int Lib,int Days, int[] b_score ,int[] no_of_days_sign, int[] no_of_books_to_scan, ArrayList<Integer>[] books_in_lib, boolean[] book_is_taken,int[] no_of_books_in_lib) {
        int best_lib=-1,best_score=0,min_no_of_days_sign=99999;
