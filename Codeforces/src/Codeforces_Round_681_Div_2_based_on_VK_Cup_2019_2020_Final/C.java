 ...
 */
package Codeforces_Round_681_Div_2_based_on_VK_Cup_2019_2020_Final;
...
public class C {
    ...
    public static long solve(int n,long arr[],long brr[]) {
        ...
        ans=Math.min(ans,get(prefix,0,n-1));
        for(int i=0;i<n-1;i++) {
            ans=Math.min(ans,Math.max(arr[i],get(prefix,i+1,n-1)));
        }
  ...
  static void heapSort(long arr[],long brr[], int n) 
  { 
