 ...
 */
package Codeforces_Round_682_Div_2;
...
//            System.out.println();
            ...
            for(int i=1;i<n-1;i++) {
                ...
                arr[i]=arr[i+1]=arr[0];
                ans.append(indx[0]+" "+indx[i]+" "+indx[i+1]+"\n");
                cnt++;
            }
            ...
            if(arr[n-2]==arr[0]) {
                if((n-2+1)%2==0) {
                    for(int i=0;i<=n-2;i+=2) {
                        ...
                        ans.append(indx[i]+" "+indx[i+1]+" "+indx[n-1]+"\n");
                        cnt++;
                    }
                    break;
                }
            ...
            for(int i=n-1;i>=2;i--) {
                ...
                ans.append(indx[i]+" "+indx[i-1]+" "+indx[i-2]+"\n");
                cnt++;
            }
